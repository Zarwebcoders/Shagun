...
async function checkAllProducts() {
    try {
        ...
        console.log(`\nFound ${prods.length} products total.`);

        prods.forEach((p, i) => {
            console.log(`${i+1}. Product: ${p.packag_type} | Daily Return: ${p.daily_return_amount} | Status (approve): ${p.approve} (Type: ${typeof p.approve})`);
        });
