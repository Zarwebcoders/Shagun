...
async function distributeLevelIncome25(userId, baseAmount, quantity, productId, forcedRate = null) {
    try {
        ...
        while (levelDistributed < 25) {
            ...
            // Removed dynamic compression check so deactivated users receive income
            // Distribute to this user as Level (levelDistributed + 1)
    ...
    try {
        ...
        if (isMilkish15k) {
            ...
            while (levelDistributed < MILKISH_LEVELS.length) {
                ...
                // Removed dynamic compression check for Milkish referral
            ...
            while (!distributed) {
                ...
                // Removed dynamic compression check for Standard referral
