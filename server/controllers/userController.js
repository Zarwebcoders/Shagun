...
const deleteUser = async (req, res) => {
    try {
        ...
        // Build case-insensitive identifier array to ensure robust cleanup
        const userIdentifiers = [
            user._id ? user._id.toString() : null,
            user.user_id,
            user.user_id ? user.user_id.toLowerCase() : null,
            user.user_id ? user.user_id.toUpperCase() : null,
            user.referral_id,
            user.referral_id ? user.referral_id.toLowerCase() : null,
            user.referral_id ? user.referral_id.toUpperCase() : null,
            user.id
        ].filter(Boolean);
        const uniqueUserIdentifiers = [...new Set(userIdentifiers)];
