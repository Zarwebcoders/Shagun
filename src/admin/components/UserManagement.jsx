    ...
    return (
      ...
      `}</style>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <button className="px-6 py-3 bg-gradient-to-r from-[#9131e7] to-[#e3459b] text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-[#9131e7]/20 transition-all">
                    + Add New User
                </button>
            </div>
            ...
            <div className="bg-[#0f0f1a] rounded-xl p-6 border border-[#9131e7]/30">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <select className="px-4 py-3 bg-[#1a1a2e] text-white rounded-lg border border-[#9131e7]/30 focus:border-[#9131e7] focus:outline-none transition-all">
                        ...
                        <tbody className="divide-y divide-[#9131e7]/30">
                            {users.map((user) => (
                                <tr key={user._id} className="hover:bg-[#1a1a2e] transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <code className="text-[#9131e7] text-sm">{user.wallet}</code>
                                    </td>
                                    <td className="px-6 py-4">
