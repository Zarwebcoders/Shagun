...
const faqs = [
    { q: "How does the free token offer work?", a: "When you purchase the Milkish Herbal Feed pack worth ₹1,50,000, you instantly receive tokens worth ₹1,00,000 in your wallet. These tokens can be used for mining to earn daily returns." },
            ...
            <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="px-5 py-2 rounded-full border border-white/10 hover:bg-white/5 hover:border-white/20 transition-all text-sm font-medium"
                    >
                        Login
                    </button>
                </div>
                ...
                >
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 mb-10 text-left max-w-xl hover:border-white/20 transition-colors shadow-2xl relative overflow-hidden group">
                        ...
                        <p className="text-lg text-gray-200 leading-relaxed relative z-10">
                            Buy premium herbal animal feed worth <span className="font-bold text-white text-xl">₹1,50,000</span> and get <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 font-bold text-xl">FREE tokens worth ₹1,00,000</span> to mine, earn 20% commission.
                        </p>
                    </div>
            ...
            <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-8 mb-10 border-b border-white/10 pb-10">
                    <div className="shrink-0 group">
                        <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600 transition-all group-hover:scale-110 origin-left">₹1,50,000</p>
