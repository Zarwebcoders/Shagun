                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6 mb-6 md:mb-8 pb-6 md:pb-8 border-b border-[#444]">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {profile.walletConnected && (
                            <p className="text-teal-400 text-xs md:text-sm font-mono">
                                {profile.walletAddress ? `${profile.walletAddress.substring(0, 6)}...${profile.walletAddress.substring(profile.walletAddress.length - 4)}` : ""}
                            </p>
                        )}
