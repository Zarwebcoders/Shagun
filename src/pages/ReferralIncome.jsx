        ...
        <div className="w-full space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                <div className="bg-gradient-to-br from-[#040408] to-[#1f1f1f] p-4 md:p-6 rounded-lg border border-[#444]">
                    ...
                    <p className="text-2xl md:text-3xl font-bold text-[#9131e7]">${totalReferralIncome.toFixed(2)}</p>
                </div>
                <div className="bg-gradient-to-br from-[#040408] to-[#1f1f1f] p-4 md:p-6 rounded-lg border border-[#444]">
                    <h3 className="text-[#b0b0b0] text-xs md:text-sm mb-2">Pending Income</h3>
                    <p className="text-2xl md:text-3xl font-bold text-yellow-400">${pendingIncome.toFixed(2)}</p>
                </div>
                <div className="bg-gradient-to-br from-[#040408] to-[#1f1f1f] p-4 md:p-6 rounded-lg border border-[#444]">
