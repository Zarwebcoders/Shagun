    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                const [userRes, downlineRes, referralRes, historyRes, settingsRes] = await Promise.all([
                    client.get('/auth/me'),
                    client.get('/users/downline').catch(() => ({ data: [] })),
                    client.get('/referral-incomes/my-referrals').catch(() => ({ data: [] })),
                ...
                const levelIncomeTokens = Number(userData.level_income || 0);
