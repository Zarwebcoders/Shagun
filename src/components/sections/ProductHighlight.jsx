                    ...
                    >
                        ...
                        <div className="bg-white/5 rounded-2xl p-6 border border-white/10 mb-8">
                            ...
                            <p className="text-gray-300">
                                Purchase products worth <span className="text-emerald-400 font-bold">₹1,50,000</span> and receive FREE bonus tokens worth <span className="text-yellow-400 font-bold">₹1,00,000</span> instantly!
                            </p>
                        </div>
