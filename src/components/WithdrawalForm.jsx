                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            step="0.01"
                            min="10"
                            className="w-full px-3 md:px-4 py-2 md:py-3 pl-10 md:pl-12 bg-[#1a1a2e] border border-[#444] text-white rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/30 transition-all text-sm md:text-base font-mono"
                        />
                    ...
                    <div className="flex justify-between mt-1 md:mt-2">
                        <span className="text-xs text-gray-400">Minimum: {formData.source === 'annual' ? '₹' : 'SGN '} 10</span>
